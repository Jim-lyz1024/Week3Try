...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="LGDS")  
    parser.add_argument("--model-config-file", type=str, default="config/lgds.yaml") 
    args = parser.parse_args()
    
    sweep_id = wandb.sweep(sweep=sweep_configuration, project="lgds")
