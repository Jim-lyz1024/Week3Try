...
class OfficeHomeP(DatasetBase):
    """
    OfficeHomeP Statistics:
    ...
    def __init__(self, cfg):
        self._dataset_dir = "office_home_copy_processed"  # 修改数据集目录
        ...
        if not os.path.exists(self._dataset_dir):
            self.download_data_from_gdrive(os.path.join(root, "office_home_copy_processed.zip"))
