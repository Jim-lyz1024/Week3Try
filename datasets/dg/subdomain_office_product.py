...
class OfficeHomeSubdomainProduct(DatasetBase):
    """
    ...
    def __init__(self, cfg):
        self._dataset_dir = "OfficeHome-subdomain-product"
        self._domains = [
            "art0", "art1", "art2", "clipart0", "clipart1", "clipart2",
            "product",
            "real_world0", "real_world1", "real_world2"
        ]
