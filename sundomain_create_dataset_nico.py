...
# Usage
original_dataset_path = "data/nico_copy/autumn"
new_dataset_path = "data/NICO-subdomain-autumn"
subdomain_mapping_path = "subdomain_mappings/subdomain_DBSCAN_nico_autumn_mapping.json"

create_subdomain_dataset(
    original_dataset_path,
    subdomain_mapping_path,
    new_dataset_path,
    'autumn'
)
